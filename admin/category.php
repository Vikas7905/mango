			...
			<div class="container">
							...
							<div class="module">
								...
								<div class="module-body">
										...
										<div class="alert alert-success">
											...
											<strong>Well done!</strong> <?php echo htmlentities($_SESSION['message']); ?><?php echo htmlentities($_SESSION['message'] = ""); ?>
										</div>
									...
									<form class="form-horizontal row-fluid"  action="action/category_post.php" name="Category" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" placeholder="Category Percentage" name="sgst" class="span8 tip" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" placeholder="Category Percentage" name="cgst" class="span8 tip" required>
											</div>
										</div>
                ...
                ?>	
												<tr>
													...
													<td><?php echo $result->records[$i]->cgst;?></td>
													<td><?php echo $result->records[$i]->sgst;?></td>
													...
													<td>
														...
														<form class="form-horizontal row-fluid"  action="action/categoryDelete_post.php" name="Category" method="post" enctype="multipart/form-data">
															...
															<input type="hidden" name="name" value="<?php echo $result->records[$i]->name ?>">
															<input type="hidden" name="commision" value="<?php echo $result->records[$i]->commision?>">
															<input type="hidden" name="sgst" value="<?php echo $result->records[$i]->sgst ?>">
															<input type="hidden" name="cgst" value="<?php echo $result->records[$i]->cgst ?>">
															<input type="hidden" name="description" value="<?php echo $result->records[$i]->description ?>">
