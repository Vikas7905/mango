...
<div class="span3">
	<div class="sidebar">
		...
		<ul class="widget widget-menu unstyled">
			...
			<li><a href="#"><i class="menu-icon icon-tasks"></i>Today Payment History</a></li>
			...
			<!-- <li><a href="insert-seller.php"><i class="menu-icon icon-paste"></i>Insert seller</a></li> -->
			<!-- <li><a href="manage-seller.php"><i class="menu-icon icon-paste"></i>Manage seller</a></li> -->
