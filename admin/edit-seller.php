						...
						<div class="content">
							...
							<div class="module">
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="sellerUpdate" method="post" enctype="multipart/form-data" action="action/updateSellerPost.php">
										<?php
										...
										?>	
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text"  name="sellerName" value="<?php echo $result->records[$i]->sellerName;?>" class="span8 tip" required>
												</div>
											</div>
