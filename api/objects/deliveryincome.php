...
class Deliveryincome
{
    ...
    public $id, $userId, $userType, $city, $state, $name, $email,$email_id, $contactno, $password, $regDate, $seller_name,$seller_id,$father,$address, $sellerId, $mobile_no,$payment_status,$pincode,$created_on, $created_by, $emp_id, $alterMobile, $businessDay, $userWebsite, $deliveryId, $establishmentYear, $paymentMode, $businessTiming, $userServices, $aboutUser, $status, $remark, $createdOn,$pan,$aadhar,$orderId,$amount,$commision,$otherCommision,$fuelCharges,$tipAmount,
    ...
    {
        $query = "Select sellerId,deliveryId,orderId,amount,commision,otherCommision,fuelCharges,tipAmount,createdOn,createdBy from " . $this->deliveryincome . " where id=:id";
