...

{
    ...
    $insert_category->c_id = $data->c_id;
   ...
   // $insert_category->image = $data->image;
    ...
    //var_dump($exam);
    // create the reg
    if($insert_category->insertcategoriesHistory()){

        http_response_code(201);
        echo json_encode(array("message"=>"History Created"));
    }
    else{
        ...
        // tell the user
        echo json_encode(array("message" => "Error to History Created"));
    }
}
}
catch (Exception $e){
