...

{
    ...
    $insert_product->image = $data->image;
    $insert_product->status = $data->status;
    $insert_product->mainimage = $data->mainimage;
    $insert_product->subCategoryId=$data->subCategoryId;
