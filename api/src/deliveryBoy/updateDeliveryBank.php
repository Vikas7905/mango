...
{
    // $update_delivery->id=$data->id;
    $update_delivery->accountNo=$data->accountNo;
    $update_delivery->bankName=$data->bankName;
    $update_delivery->ifscCode=$data->ifscCode;
    $update_delivery->accountHolderName=$data->accountHolderName;
    

    if($update_delivery->updateDeliveryboyBank()){
